...
class NotificationAppBarWidget extends StatefulWidget implements PreferredSizeWidget {
  ...
  @override
  State<NotificationAppBarWidget> createState() => _NotificationAppBarWidgetState();
}

class _NotificationAppBarWidgetState extends State<NotificationAppBarWidget> {
  ...
  PreferredSizeWidget build(BuildContext context) {
    return MyAppBar(
        ...
        title: _isSearching ? _buildSearchField() : Text(
          "Yangi Kirimlar", style: TextStyleConstants.appBarTitleStyle,),
        centerTitle: true,
  ...
  void updateSearchQuery(String newQuery) async{
    ...
    // write your bloc to manage notifications     context.read<MarketsListBloc>().add(UpdateMarketsListEvent(query: newQuery));
  }
